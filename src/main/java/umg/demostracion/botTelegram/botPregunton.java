...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_2", new String[]{"Pregunta 2.1", "Que edad tienes? 2.2", "Pregunta 2.3"});
        preguntas.put("SECTION_3", new String[]{"Pregunta 3.1", "Pregunta 3.2", "Pregunta 3.3"});
        preguntas.put("SECTION_4", new String[]{"❤️❤️Pregunta 4.1", "👍👍Pregunta 4.2", "🤷‍♀️🤷‍♀️Pregunta 4.3", "😜😜Pregunta 4.4", "🥰🥰Pregunta 4.5", "👌👌Pregunta 4.6"});
    }
